...
function draw() {
  ...
  heart.x = balloon.x - 500;
  heart1.x = balloon.x - 450;
  heart2.x = balloon.x - 400;
...
spawnCoin();
  ...
  stroke("white");
  textSize(25);
  text("Use arrow keys to move Hot Air Balloon!",balloon.x - 600, balloon.y - 250);
}
...
function readPosition(data){
  ...
  function spawnCoin(){
    ...
    if(frameCount % 5 === 0){
      ...
      coin.x = balloon.x + 500;
      coin.y = Math.round(random(-100000, 100000));
      // coin.velocityX = -5;
